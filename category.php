...
if(!empty($_SESSION['activo'])){
    ...
    if(isset($_POST['btn_guardar'])){
        ...
        $q_i_cat="INSERT INTO categorias (Descripcion) VALUES('$nom')";
        $query_insert=mysqli_query($cn,$q_i_cat);
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el nombre de la categoría" required="" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la categoría" name="cat_nom">
                            ...
                            <p class="text-center">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="zmdi zmdi-floppy" name="btn_guardar"></i> &nbsp;&nbsp; Guardar</button>
                            </p> 
                       </div>
                    </div>
                </form>
